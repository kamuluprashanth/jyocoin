// Copyright (c) 2012-2016, The CryptoNote developers, The Bytecoin developers, The Karbowanec developers, The Elyacoin developers
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x19; // addresses start with "eL"
...
const uint32_t UPGRADE_HEIGHT_V3                             = 138000;
...
const int      P2P_DEFAULT_PORT                              =  45215;
const int      RPC_DEFAULT_PORT                              =  45216;
